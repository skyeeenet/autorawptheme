...
class FooterRecentPostsWidget extends WP_Widget {


	public function __construct() {
		$widget_ops = array(
			'classname'                   => 'FooterRecentPostsWidget',
			'description'                 => __( 'FooterRecentPostsWidget' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'FooterRecentPostsWidget', 'FooterRecentPostsWidget', $widget_ops );
		$this->alt_option_name = 'FooterRecentPostsWidget';
	}
